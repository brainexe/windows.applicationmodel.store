...
if (false && fs.existsSync(path.join(__dirname, 'NodeRT_Windows_ApplicationModel_Store.d.js)'))) {
  module.exports = require('./NodeRT_Windows_ApplicationModel_Store.d.js');
} else {
